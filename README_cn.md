...
<div align="center">
  ...
  <a href="https://github.com/tossp/metamcp/pkgs/container/metamcp" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/GHCR-ts-green.svg?style=flat-square&logo=github" alt="GHCR ts 镜像" style="max-width: 100%;">
  </a>
...
Compose 文件跟随本分叉的滚动通道 `ghcr.io/tossp/metamcp:ts`。首次切换期间，必须等本基线合并且 `ts` 发布工作流首次成功后该镜像才可用；在包和 digest 可见之前，请保留现有可工作的部署。
